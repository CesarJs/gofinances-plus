export const categories_default = [
	...
	{ key: 'carro', name: 'Carro', icon: 'crosshair', color: '#E83F5B', type: 'negative'},
	{ key: 'lazer', name: 'Lazer', icon: 'heart', color: '#26195C', type: 'negative'},
	{ key: 'estudos', name: 'Estudos', icon: 'book', color: '#9C001A', type: 'negative'},
];
